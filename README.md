...
An end-to-end forecasting project that implements and compares multiple time-series models—ranging from Simple Exponential Smoothing to SARIMA—to predict residential energy usage and analyze the impact of exogenous shocks.
